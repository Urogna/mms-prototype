...
var DoubleBox = function DoubleBox(_ref4) {
  var name = _ref4.name,
      ...
      first = _ref4.first,
      second = _ref4.second;
  var css = "px-2 py-2 bg-".concat(color, "-400 h-auto w-full rounded");
  return __jsx("p", {
    className: css,
    __source: {
      fileName: _jsxFileName,
...
var Box = function Box(_ref5) {
  ...
  return __jsx("p", {
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-1/3 rounded-full border-2 border-").concat(color, "-600"),
...
//# sourceMappingURL=index.js.d617f37837098424c631.hot-update.js.map