...
var Item = function Item(_ref) {
  ...
  if (selected) {
    ...
    return __jsx("p", {
      ...
      className: "w-1/2 float-left h-full px-12 pb-2 bg-gray-300 border-4 border-r-2 border-white",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 40
      },
      ...
      className: "bg-gray-300 w-1/2 border-4 border-l-2 border-white float-right",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 42
      },
...
//# sourceMappingURL=home.js.8e8c9bf937f8bf6f23a6.hot-update.js.map