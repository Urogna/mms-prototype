...
var DoubleBox = function DoubleBox(_ref5) {
  ...
  return __jsx("div", {
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-2/6 rounded-full px-1 border-2 border-").concat(color, "-600"),
    placeholder: first,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 107
...
var Box = function Box(_ref6) {
  ...
  return __jsx("div", {
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-2/3 rounded-full border-2 border-").concat(color, "-600"),
...
//# sourceMappingURL=index.js.e5851ab8e2f6482791b1.hot-update.js.map