...
var DoubleBox = function DoubleBox(_ref4) {
  var name = _ref4.name,
      ...
      first = _ref4.first,
      second = _ref4.second;
  var css = "py-2 bg-".concat(color, "-400 h-auto w-full rounded overflow-hidden");
  return __jsx("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 78
...
var Box = function Box(_ref5) {
  ...
  var css = "py-2 bg-".concat(color, "-400 h-auto w-full rounded");
  return __jsx("div", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102
...
//# sourceMappingURL=index.js.c49caddd34159c94b81e.hot-update.js.map