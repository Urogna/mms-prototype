...
var Box = function Box(_ref5) {
  ...
  return __jsx("p", {
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-2/3 rounded-full px-1 border-2 border-").concat(color, "-600"),
...
//# sourceMappingURL=index.js.645bbbf2330db0565e0f.hot-update.js.map