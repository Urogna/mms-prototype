...
var StartForm = function StartForm(_ref3) {
  ...
  var box = "px-2 py-2 ml-8 h-auto w-full rounded";
  var input = "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-1/4 rounded-full px-1 border-2 border-").concat(color, "-600 float-right mr-1/4");
  var price = "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-12 rounded-full px-1 border-2 border-").concat(color, "-600 mx-1");
...
//# sourceMappingURL=index.js.22bd1c3fe37bc65b0e92.hot-update.js.map