...
var Item = function Item(_ref) {
  ...
  if (selected) {
    return __jsx("p", {
      className: "bg-white border-2 border-gray-600 shadow text-lg overflow-hidden text-center",
    ...
    return __jsx("p", {
      className: "h-24 bg-white border-2 border-gray-600 shadow text-lg overflow-hidden text-center",
      onClick: function onClick() {
        setSelected(true);
      },
      __source: {
      ...
      className: "w-1/2 float-left h-auto",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 37
      },
...
//# sourceMappingURL=home.js.bfa22b7ea04c42a207f0.hot-update.js.map