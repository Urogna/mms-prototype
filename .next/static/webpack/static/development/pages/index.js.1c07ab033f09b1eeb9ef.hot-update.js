...
var StartForm = function StartForm(_ref3) {
  ...
  var submit = "p-1 w-1/3 text-2xl border-2 border-".concat(color, "-800 bg-transparent hover:bg-").concat(color, "-700 hover:text-white ml-1/4 my-2 rounded-full active:bg-").concat(color, "-900 focus:outline-none");
  return __jsx("form", {
    onSubmit: handleSubmit,
...
//# sourceMappingURL=index.js.1c07ab033f09b1eeb9ef.hot-update.js.map