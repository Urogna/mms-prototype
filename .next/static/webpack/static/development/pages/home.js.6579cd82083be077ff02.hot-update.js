...
var Item = function Item(_ref) {
  ...
  if (selected) {
    ...
    return __jsx("p", {
      className: "h-64 bg-white border-4 border-gray-600 shadow text-lg overflow-hidden text-center",
      onClick: function onClick() {
        setSelected(true);
      },
      __source: {
...
//# sourceMappingURL=home.js.6579cd82083be077ff02.hot-update.js.map