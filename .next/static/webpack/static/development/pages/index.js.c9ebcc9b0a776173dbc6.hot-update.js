...
var Box = function Box(_ref4) {
  ...
  return __jsx("p", {
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-1/3 rounded-full px-1 border-2 border-").concat(color, "-600 float-right mr-1/4"),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 96
    },
...
//# sourceMappingURL=index.js.c9ebcc9b0a776173dbc6.hot-update.js.map