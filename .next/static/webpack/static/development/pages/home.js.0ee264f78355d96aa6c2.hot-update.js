...
var Item = function Item(_ref) {
  ...
  if (selected) {
    ...
    return __jsx("p", {
      className: "h-24 bg-white border-2 border-gray-600 shadow text-xs overflow-hidden text-center p-2",
      onClick: function onClick() {
        setSelected(true);
      },
      __source: {
      ...
      className: "w-1/2 float-left -mt-1 -ml-1",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 36
      },
...
//# sourceMappingURL=home.js.0ee264f78355d96aa6c2.hot-update.js.map