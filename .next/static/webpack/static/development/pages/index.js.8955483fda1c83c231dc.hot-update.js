...
var DoubleBox = function DoubleBox(_ref4) {
  var name = _ref4.name,
      ...
      first = _ref4.first,
      second = _ref4.second;
  var css = "px-2 bg-".concat(color, "-400 h-auto w-full rounded overflow-hidden");
  return __jsx("p", {
    className: css,
    __source: {
      fileName: _jsxFileName,
    ...
    className: "h-auto text-2xl text-center w-1/3 float-left",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 84
    },
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-1/4 rounded-full px-1 border-2 border-").concat(color, "-600"),
    placeholder: first,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 88
...
var Box = function Box(_ref5) {
  ...
  return __jsx("p", {
    ...
    type: "text",
    className: "bg-".concat(color, "-200 text-base placeholder-blue-700 text-center h-10 w-1/2 rounded-full px-1 border-2 border-").concat(color, "-600"),
...
//# sourceMappingURL=index.js.8955483fda1c83c231dc.hot-update.js.map