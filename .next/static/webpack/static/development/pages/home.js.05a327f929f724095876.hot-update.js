...
var Item = function Item(_ref) {
  ...
  if (selected) {
    return __jsx("p", {
      className: "bg-white border-2 border-gray-600 shadow text-xs overflow-hidden",
      ...
      className: "pt-2 float-left text-center text-xs shadow ml-auto -mr-auto",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 25
      },
    ...
    return __jsx("p", {
      className: "h-24 bg-white border-2 border-gray-600 shadow text-xs overflow-hidden",
      onClick: function onClick() {
        setSelected(true);
      },
      __source: {
      ...
      className: "w-1/2 p-1 float-left",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 36
      },
      ...
      className: "w-1/2 pt-2 float-right text-center text-xs shadow",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 37
      },
...
//# sourceMappingURL=home.js.05a327f929f724095876.hot-update.js.map