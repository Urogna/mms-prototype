...
var StartForm = function StartForm(_ref3) {
  ...
  var input = "bg-".concat(color, "-200 placeholder-blue-700 text-center h-10 w-24 rounded-full px-1 border-2 border-").concat(color, "-600 float-right mr-1/4");
  var price = "bg-".concat(color, "-200 placeholder-blue-700 text-center h-10 w-12 rounded-full px-1 border-2 border-").concat(color, "-600 mx-1");
...
//# sourceMappingURL=index.js.bdf5455a22653b8fb2de.hot-update.js.map