...
var StartForm = function StartForm(_ref3) {
  ...
  return __jsx("form", {
    ...
    className: "py-2 mx-1/12 ".concat(text, " float-left"),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 70
    },
...
var Box = function Box(_ref4) {
  ...
  return __jsx("p", {
    ...
    className: "h-auto text-2xl w-1/2 float-left",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 92
    },
...
var TextDisplay = function TextDisplay(_ref6) {
  var text = _ref6.text;
...
var Submit = function Submit(_ref9) {
  var text = _ref9.text,
      color = _ref9.color;
...
//# sourceMappingURL=index.js.0cd74d3224bdf812ebc5.hot-update.js.map